...
const ROICalculator = () => {
  ...
  return (
    ...
    >
      ...
      <div
  ref={boxRef}
  className=" mx-auto max-w-4xl transform opacity-0 -translate-x-20 rounded-2xl  bg-[#0a2133] backdrop-blur-xl p-10 transition-all duration-1000 ease-out hover:-translate-y-1 hover:shadow-glow opacity-90"
    >
