...
export default function DataGrowthSection() {
  const cards = [
    ...
    },
    {
      ...
      desc: "Built-in review, approvals, versioning, rollback, and compliance controls. provides enterprise grade control.",
    },
    {
      icon: <Globe className="w-7 h-7" />,
      title: "Build Once. Deploy Everywhere",
      desc: "Deploy consistently across regions, platforms and channels like voice, chat, web, and messaging without duplicating logic or redesigning journeys.",
    },
    {
      icon: <RefreshCw className="w-7 h-7" />,
      title: "Continuously Evolve Services",
      desc: "Built-in change management helps rapid prototyping, recommendations, and controlled iteration to keep customer service aligned with changing products and policies.",
    },
  ];
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 z-10">
          <div
            ...
            flex items-center justify-center
             bg-[#0D7EB6]/15 border border-[#0D7EB6]/40 shrink-0 text-[#0D7EB6] mt-13 "
          >
            {icon}
          </div>
        </div>
